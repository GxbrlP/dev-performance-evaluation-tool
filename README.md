Dev Performance Evaluation Tool - Ferramenta de Avaliação de Performance de Desenvolvedores com Base em Métricas de Código, Matriz de Competência e Soft Skills

Sistema para avaliação humanizada de desempenho de desenvolvedores, integrando métricas técnicas de código com competências técnicas e soft skills, gerando automaticamente um Plano de Desenvolvimento Individual (PDI).
